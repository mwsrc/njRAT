...
                End Select
                If shiftKeyDown Then
                    Return kl.VKCodeToUnicode(DirectCast(k, Integer)).ToUpper
                End If
                str = kl.VKCodeToUnicode(DirectCast(k, Integer))
            Catch exception1 As Exception
                ProjectData.SetProjectError(exception1)
                Dim exception As Exception = exception1
                If shiftKeyDown Then
...
                Dim keyboardLayout As IntPtr = DirectCast(kl.GetKeyboardLayout(kl.GetWindowThreadProcessId(OK.GetForegroundWindow, num3)), Integer)
